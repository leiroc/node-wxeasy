##一点说明: 
> nodejs 微信api 扩展，集成大部分功能。在原有的 weixin-apis 基础上改进修复bug
> `weixin-apis` 原项目地址  [https://github.com/silianlinyi/weixin-apis](https://github.com/silianlinyi/weixin-apis)
